...
C       Zd_ti_i_IC - Initial Z velocity of target w.r.t. ICS, expressed in ICS [m/sec]
C     Outputs:
C       X_ti_i  - X position of target w.r.t. ICS, expressed in ICS [m]
C       Xd_ti_i - X velocity of target w.r.t. ICS, expressed in ICS [m/sec]
C       Z_ti_i  - Z position of target w.r.t. ICS, expressed in ICS [m]
C       Zd_ti_i - Z velocity of target w.r.t. ICS, expressed in ICS [m/sec]
C
C       Internal variables and constants:
C           None.
C
