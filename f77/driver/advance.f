...
C
C  This subroutine solves differential equation initial value
C  problems; note that the initial derivatives are assumed to have
C  been evaluated prior to the subroutine call.
C
C  Inputs:
