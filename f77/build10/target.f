...
C
C     This subroutine sets the default data for the target motion model.
C
C     Inputs:
C       None.
C
C     Outputs:
C       X_ti_i_IC  - Initial position of target WRT ICS in ICS [m]
C       Y_ti_i_IC
C       Z_ti_i_IC
C       Xd_ti_i_IC - Initial velocity of target WRT ICS in ICS [m/sec]
C       Yd_ti_i_IC
C       Zd_ti_i_IC
C
...
C
      ...
      Subroutine Target
C
C     This subroutine determines the target motion.
C
C     Inputs:
...
C       Y_ti_i_IC
C       Z_ti_i_IC
C       Xd_ti_i   - Velocity of target WRT ICS in ICS [m]
C       Yd_ti_i
C       Zd_ti_i
C
C     Outputs:
