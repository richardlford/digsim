...
Definition _diffs : ident := 54%positive.
Definition _dt : ident := 56%positive.
Definition _i : ident := 57%positive.
Definition _main : ident := 59%positive.
Definition _n : ident := 55%positive.
Definition _state : ident := 53%positive.
Definition _stepn : ident := 58%positive.
...
Definition f_stepn := {|
  ...
  fn_params := ((_state, (tptr tdouble)) :: (_diffs, (tptr tdouble)) ::
                (_n, tuint) :: (_dt, tdouble) :: nil);
  fn_vars := nil;
  ...
  (Sloop
    (Ssequence
      ...
      (Ssequence
        (Sset _t'1
          (Ederef
            (Ebinop Oadd (Etempvar _state (tptr tdouble)) (Etempvar _i tint)
              (tptr tdouble)) tdouble))
        (Ssequence
          (Sset _t'2
            (Ederef
              (Ebinop Oadd (Etempvar _diffs (tptr tdouble))
                (Etempvar _i tint) (tptr tdouble)) tdouble))
          (Sassign
            (Ederef
              (Ebinop Oadd (Etempvar _state (tptr tdouble))
                (Etempvar _i tint) (tptr tdouble)) tdouble)
...
((___builtin_ais_annot,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_stepn, Gfun(Internal f_stepn)) :: nil).

Definition public_idents : list ident :=
(_stepn :: ___builtin_debug :: ___builtin_nop ::
