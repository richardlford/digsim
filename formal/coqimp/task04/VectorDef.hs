...
t_rect :: a2 -> (a1 -> Prelude.Integer -> (Coq_t a1) -> a2 -> a2) ->
...
t_rec :: a2 -> (a1 -> Prelude.Integer -> (Coq_t a1) -> a2 -> a2) ->
         Prelude.Integer -> (Coq_t a1) -> a2
t_rec =
  t_rect
...
caseS :: (a1 -> Prelude.Integer -> (Coq_t a1) -> a2) -> Prelude.Integer ->
         (Coq_t a1) -> a2
caseS h _ v =
  case v of {
   Coq_nil -> __;
...
rect2 :: a3 -> (Prelude.Integer -> (Coq_t a1) -> (Coq_t a2) -> a3 -> a1 -> a2
         -> a3) -> Prelude.Integer -> (Coq_t a1) -> (Coq_t a2) -> a3
...
replace_order :: Prelude.Integer -> (Coq_t a1) -> Prelude.Integer -> a1 ->
                 Coq_t a1
replace_order n v p =
...
shiftrepeat =
  rectS (\h -> Coq_cons h (Prelude.succ 0) (Coq_cons h 0 Coq_nil))
    (\h n _ h0 -> Coq_cons h (Prelude.succ (Prelude.succ n)) h0)
...
append :: Prelude.Integer -> Prelude.Integer -> (Coq_t a1) -> (Coq_t 
          a1) -> Coq_t a1
append _ p v w =
  case v of {
   Coq_nil -> w;
...
rev_append :: Prelude.Integer -> Prelude.Integer -> (Coq_t a1) -> (Coq_t 
              a1) -> Coq_t a1
rev_append n p v w =
  Logic.eq_rect_r (Plus.tail_plus n p) (rev_append_tail n p v w)
    ((Prelude.+) n p)
...
map2 :: (a1 -> a2 -> a3) -> Prelude.Integer -> (Coq_t a1) -> (Coq_t a2) ->
        Coq_t a3
map2 g =
...
fold_right2 :: (a1 -> a2 -> a3 -> a3) -> a3 -> Prelude.Integer -> (Coq_t 
               a1) -> (Coq_t a2) -> a3
fold_right2 g c =
  rect2 c (\_ _ _ h a b -> g a b h)

fold_left2 :: (a1 -> a2 -> a3 -> a1) -> a1 -> Prelude.Integer -> (Coq_t 
              a2) -> (Coq_t a3) -> a1
fold_left2 f a _ v w =
  case v of {
   Coq_nil -> case0 a w;
   Coq_cons vh vn vt ->
    caseS' vn w (\wh wt -> fold_left2 f (f a vh wh) vn vt wt)}
