...
ordered_of_comparison :: (Prelude.Maybe Datatypes.Coq_comparison) ->
                         Prelude.Bool
...
_Float__transform_quiet_pl :: Fappli_IEEE.Coq_nan_pl ->
                              Fappli_IEEE.Coq_nan_pl
_Float__transform_quiet_pl pl =
  BinPos._Pos__lor (Specif.proj1_sig pl)
    (Fcore_Zaux.iter_nat (\x -> (\x -> 2 Prelude.* x) x) (Prelude.succ
...
_Float__of_single_pl :: Prelude.Bool -> Fappli_IEEE.Coq_nan_pl -> (,)
...
_Float__to_single_pl :: Prelude.Bool -> Fappli_IEEE.Coq_nan_pl -> (,)
                        Prelude.Bool Fappli_IEEE.Coq_nan_pl
...
_Float__binop_pl :: Fappli_IEEE_bits.Coq_binary64 ->
                    Fappli_IEEE_bits.Coq_binary64 -> (,) Prelude.Bool
                    Fappli_IEEE.Coq_nan_pl
...
_Float__neg =
  Fappli_IEEE.coq_Bopp ((\x -> x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) 1))))))))))) _Float__neg_pl
...
_Float__abs =
  Fappli_IEEE.coq_Babs ((\x -> x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) 1))))))))))) _Float__abs_pl
...
_Float__compare :: Coq_float -> Coq_float -> Prelude.Maybe
...
_Float__compare f1 f2 =
  Fappli_IEEE.coq_Bcompare ((\x -> x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) 1))))))))))) f1 f2

_Float__cmp :: Integers.Coq_comparison -> Coq_float -> Coq_float ->
               Prelude.Bool
_Float__cmp c f1 f2 =
...
_Float__of_single =
  Fappli_IEEE_extra.coq_Bconv ((\x -> x) ((\x -> 2 Prelude.* x)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) 1))))))))))) _Float__of_single_pl
    Fappli_IEEE.Coq_mode_NE
...
_Float__from_parsed base intPart expPart =
  Fappli_IEEE_extra.coq_Bparse ((\x -> x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) 1))))))))))) base intPart
    expPart
...
_Float__from_words :: Integers.Int__Coq_int -> Integers.Int__Coq_int ->
                      Coq_float
...
_Float__exact_inverse =
  Fappli_IEEE_extra.coq_Bexact_inverse ((\x -> x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1)))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
_Float__ox4330_0000 =
  Integers._Int__repr ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
_Float32__transform_quiet_pl :: Fappli_IEEE.Coq_nan_pl ->
                                Fappli_IEEE.Coq_nan_pl
...
_Float32__neg_pl :: Prelude.Bool -> Fappli_IEEE.Coq_nan_pl -> (,)
                    Prelude.Bool Fappli_IEEE.Coq_nan_pl
_Float32__neg_pl s pl =
  (,) (Prelude.not s) pl

_Float32__abs_pl :: Prelude.Bool -> Fappli_IEEE.Coq_nan_pl -> (,)
                    Prelude.Bool Fappli_IEEE.Coq_nan_pl
_Float32__abs_pl _ pl =
  (,) Prelude.False pl

_Float32__binop_pl :: Fappli_IEEE_bits.Coq_binary32 ->
                      Fappli_IEEE_bits.Coq_binary32 -> (,) Prelude.Bool
                      Fappli_IEEE.Coq_nan_pl
...
_Float32__neg =
  Fappli_IEEE.coq_Bopp ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
_Float32__abs =
  Fappli_IEEE.coq_Babs ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
_Float32__add =
  Fappli_IEEE.coq_Bplus ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) 1)))))))) _Float32__binop_pl
    Fappli_IEEE.Coq_mode_NE

_Float32__sub :: Coq_float32 -> Coq_float32 -> Coq_float32
_Float32__sub =
  Fappli_IEEE.coq_Bminus ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
_Float32__mul =
  Fappli_IEEE.coq_Bmult ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
_Float32__div =
  Fappli_IEEE.coq_Bdiv ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
_Float32__compare f1 f2 =
  Fappli_IEEE.coq_Bcompare ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
_Float32__of_int n =
  Fappli_IEEE_extra.coq_BofZ ((\x -> x) ((\x -> 2 Prelude.* x)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) 1)))))))) (Integers._Int__signed n)
...
_Float32__of_intu n =
  Fappli_IEEE_extra.coq_BofZ ((\x -> x) ((\x -> 2 Prelude.* x)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) 1)))))))) (Integers._Int__unsigned n)
...
_Float32__of_long n =
  Fappli_IEEE_extra.coq_BofZ ((\x -> x) ((\x -> 2 Prelude.* x)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) 1)))))))) (Integers._Int64__signed n)
...
_Float32__of_longu n =
  Fappli_IEEE_extra.coq_BofZ ((\x -> x) ((\x -> 2 Prelude.* x)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) 1)))))))) (Integers._Int64__unsigned n)

_Float32__from_parsed :: Prelude.Integer -> Prelude.Integer ->
                         Prelude.Integer -> Coq_float32
_Float32__from_parsed base intPart expPart =
  Fappli_IEEE_extra.coq_Bparse ((\x -> x) ((\x -> 2 Prelude.* x)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) 1)))))))) base intPart expPart
