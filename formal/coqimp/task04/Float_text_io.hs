...
_FloatIO__Details__mantissaSign :: FloatIO__Details__FloatParts ->
                                   Prelude.Bool
  ...
  case s of {
   ...
   (:) x x0 ->
    Monad.bind (unsafeCoerce Monad.optionM)
      (_FloatIO__Details__strToUintHelper x0) (\lower ->
...
_FloatIO__Details__strToUint :: Prelude.String -> Prelude.Maybe
                                Decimal.Coq_uint
_FloatIO__Details__strToUint s =
  Monad.bind (unsafeCoerce Monad.optionM)
    (_FloatIO__Details__strToUintHelper s) (\x -> Prelude.Just
    (Decimal.unorm x))

_FloatIO__Details__strToIntHelper :: Prelude.String -> Prelude.Maybe
                                     Decimal.Coq_int
                 ...
                 Prelude.True ->
                  case b5 of {
                   Prelude.True ->
                    let {sign = Prelude.False} in
                    Monad.bind (unsafeCoerce Monad.optionM)
                      (unsafeCoerce _FloatIO__Details__strToUint s)
                   ...
                   Prelude.False ->
                    case b6 of {
                     ...
                     Prelude.False ->
                      let {sign = Prelude.False} in
                      Monad.bind (unsafeCoerce Monad.optionM)
                        (unsafeCoerce _FloatIO__Details__strToUint x0)
                        (\uintVal -> Prelude.Just
                        (case sign of {
                          Prelude.True -> Decimal.Neg uintVal;
                          Prelude.False -> Decimal.Pos uintVal}))}};
...
_FloatIO__Details__strToInt :: Prelude.String -> Prelude.Maybe
                               Decimal.Coq_int
_FloatIO__Details__strToInt s =
  Monad.bind (unsafeCoerce Monad.optionM)
    (_FloatIO__Details__strToIntHelper s) (\x -> Prelude.Just
    (Decimal.norm x))
   ...
   Prelude.False ->
    (\fO fS n -> if n Prelude.== 0 then fO () else fS (n Prelude.- 1))
      ...
      (\fO fP fN n -> if n Prelude.== 0 then fO () else
                   ...
                   fN (Prelude.negate n))
        (\_ ->
        _FloatIO__Details__repeat_string min_digits ((:) '0' ([])))
        (\_ ->
        String0.append
          (_FloatIO__Details__coq_Z_to_string_base10_aux
            (Nat.pred min_digits) x
...
_FloatIO__Details__coq_Z_to_string_base10 :: Prelude.Integer ->
                                             Prelude.Integer ->
                                             Prelude.String
...
_FloatIO__Details__coq_Z_to_string_base16_aux :: Prelude.Integer ->
                                                 Prelude.Integer ->
                                                 Prelude.Integer ->
                                                 Prelude.String
   ...
   Prelude.False ->
    (\fO fS n -> if n Prelude.== 0 then fO () else fS (n Prelude.- 1))
      ...
      (\fO fP fN n -> if n Prelude.== 0 then fO () else
        ...
        (\_ ->
        String0.append
          (_FloatIO__Details__coq_Z_to_string_base16_aux
            (Nat.pred min_digits) x
            (BinInt._Z__div num ((\x -> x) ((\x -> 2 Prelude.* x)
...
_FloatIO__Details__coq_Z_to_string_base16 :: Prelude.Integer ->
                                             Prelude.Integer ->
                                             Prelude.String
...
_FloatIO__Details__scaled_float_to_Z x fdigs =
  case Floats._Float__to_long
         (Floats._Float__mul x
           (Floats._Float__from_parsed ((\x -> 2 Prelude.* x)
             ((\x -> 2 Prelude.* x Prelude.+ 1) ((\x -> 2 Prelude.* x) 1))) 1
             fdigs)) of {
...
_FloatIO__Details__float_to_string_unsigned :: Floats.Coq_float ->
                                               Prelude.Integer ->
                                               Prelude.String
   ...
   Fappli_IEEE.B754_finite b _ e ->
    case b of {
     ...
     Prelude.False ->
      ...
      let {scale = _FloatIO__Details__scale_exp (BinInt._Z__of_nat fdigs) e}
      in
      let {scaled = _FloatIO__Details__scaled_float_to_Z x scale} in
      let {
       b10 = _FloatIO__Details__coq_Z_to_string_base10 (Prelude.succ 0)
               scaled}
      in
      ...
      let {
       b10' = case PeanoNat._Nat__ltb lb10 fdigs of {
               Prelude.True ->
                let {scaled' = _FloatIO__Details__scaled_float_to_Z x scale'}
                in
      ...
      in
      let {
       exp_string = _FloatIO__Details__coq_Z_to_signed_string_base10
                      (Prelude.succ (Prelude.succ 0)) true_exp}
      in
      String0.append d10 (String0.append ((:) 'e' ([])) exp_string)};
   _ -> ([])}

_FloatIO__Details__zero_to_string_unpadded :: Prelude.Integer ->
                                              Prelude.String
_FloatIO__Details__zero_to_string_unpadded fdigs =
  let {digs_after_dec = Nat.pred fdigs} in
  let {frac = _FloatIO__Details__repeat_string digs_after_dec ((:) '0' ([]))}
  in
  String0.append ((:) '0' ((:) '.' ([])))
    (String0.append frac ((:) 'e' ((:) '+' ((:) '0' ((:) '0' ([]))))))

_FloatIO__Details__float_to_string_unpadded :: Floats.Coq_float ->
                                               Prelude.Integer ->
                                               Prelude.String
  ...
  case x of {
    ...
    case b of {
     Prelude.True ->
      String0.append ((:) '-' ((:) 'n' ((:) 'a' ((:) 'n' ([])))))
        (_FloatIO__Details__coq_Z_to_string_base16 (Prelude.succ
          (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ
          (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ
          (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ
          (Prelude.succ 0)))))))))))))) ((\x -> x) (Specif.proj1_sig pl)));
     Prelude.False ->
      String0.append ((:) 'n' ((:) 'a' ((:) 'n' ([]))))
        (_FloatIO__Details__coq_Z_to_string_base16 (Prelude.succ
          (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ
   ...
   Fappli_IEEE.B754_finite b _ _ ->
    case b of {
     Prelude.True ->
      String0.append ((:) '-' ([]))
        (_FloatIO__Details__float_to_string_unsigned (Floats._Float__abs x)
          fdigs);
...
_FloatIO__Details__pad_to_width width s =
  ...
  let {
   pads = _FloatIO__Details__repeat_string (Nat.sub width ls) ((:) ' ' ([]))}
  in
...
_FloatIO__float_to_string :: Prelude.Integer -> Prelude.Integer ->
                             Floats.Coq_float -> Prelude.String
_FloatIO__float_to_string =
  _FloatIO__Details__float_to_string

_FloatIO__float_list_to_string :: Prelude.Integer -> Prelude.Integer ->
...
_FloatIO__coq_ZofFloat f =
  case Fappli_IEEE_extra.coq_ZofB ((\x -> x)
         ((\x -> 2 Prelude.* x Prelude.+ 1) ((\x -> 2 Prelude.* x)
         ((\x -> 2 Prelude.* x Prelude.+ 1) ((\x -> 2 Prelude.* x)
