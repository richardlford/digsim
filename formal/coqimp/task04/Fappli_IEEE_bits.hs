...
join_bits :: Prelude.Integer -> Prelude.Integer -> Prelude.Bool ->
...
binary_float_of_bits_aux :: Prelude.Integer -> Prelude.Integer ->
                            Prelude.Integer -> Fappli_IEEE.Coq_full_float
...
b32_sqrt :: Fappli_IEEE.Coq_mode -> Fappli_IEEE.Coq_binary_float ->
            Fappli_IEEE.Coq_binary_float
b32_sqrt =
  Fappli_IEEE.coq_Bsqrt ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))) ((\x -> x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
...
b64_opp =
  Fappli_IEEE.coq_Bopp ((\x -> x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) 1))))))))))) (\x x0 -> (,)
    x x0)
...
b64_plus =
  Fappli_IEEE.coq_Bplus ((\x -> x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) 1))))))))))) binop_nan_pl64
...
b64_sqrt =
  Fappli_IEEE.coq_Bsqrt ((\x -> x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ...
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x) 1))))))))))) unop_nan_pl64

b64_of_bits :: Prelude.Integer -> Coq_binary64
b64_of_bits =
  binary_float_of_bits ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))))
...
bits_of_b64 =
  bits_of_binary_float ((\x -> x) ((\x -> 2 Prelude.* x)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x Prelude.+ 1) 1))))))
    ((\x -> x) ((\x -> 2 Prelude.* x Prelude.+ 1)
    ((\x -> 2 Prelude.* x Prelude.+ 1) ((\x -> 2 Prelude.* x) 1))))
