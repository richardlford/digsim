...
_Z__Private_Dec__min_case :: Prelude.Integer -> Prelude.Integer ->
                             (Prelude.Integer -> Prelude.Integer -> () -> a1
                             -> a1) -> a1 -> a1 -> a1
_Z__Private_Dec__min_case n m x x0 x1 =
  _Z__Private_Dec__min_case_strong n m x (\_ -> x0) (\_ -> x1)

_Z__Private_Dec__min_dec :: Prelude.Integer -> Prelude.Integer ->
                            Prelude.Bool
...
_Z__max_case_strong n m x x0 =
  _Z__Private_Dec__max_case_strong n m (\_ _ _ x1 -> Logic.eq_rect __ x1 __)
    x x0
...
_Z__min_case_strong n m x x0 =
  _Z__Private_Dec__min_case_strong n m (\_ _ _ x1 -> Logic.eq_rect __ x1 __)
    x x0
