...
is_finite_pos0 :: Prelude.Integer -> Prelude.Integer ->
...
coq_Beq_dec :: Prelude.Integer -> Prelude.Integer ->
          ...
          case s of {
           Prelude.True ->
            ...
            case s0 of {
             Prelude.True ->
              Logic.eq_rec_r m0 (\_ ->
                Logic.eq_rec_r e1 (\_ -> Prelude.True) e __) m __;
             Prelude.False -> Prelude.False};
           Prelude.False -> Prelude.False};
         Prelude.False -> Prelude.False};
       Prelude.False ->
...
coq_BofZ prec emax n =
  Fappli_IEEE.binary_normalize prec emax Fappli_IEEE.Coq_mode_NE n 0
    Prelude.False
...
int_round_odd x p =
  (Prelude.*)
    (case (Prelude.||)
      ...
      Prelude.True ->
       BinInt._Z__div x
         (BinInt._Z__pow ((\x -> x) ((\x -> 2 Prelude.* x) 1)) p);
      Prelude.False ->
       (Prelude.+)
         (BinInt._Z__div x
           (BinInt._Z__pow ((\x -> x) ((\x -> 2 Prelude.* x) 1)) p))
...
coq_ZofB :: Prelude.Integer -> Prelude.Integer ->
            Fappli_IEEE.Coq_binary_float -> Prelude.Maybe Prelude.Integer
coq_ZofB _ _ f =
  case f of {
...
coq_ZofB_range :: Prelude.Integer -> Prelude.Integer ->
                  Fappli_IEEE.Coq_binary_float -> Prelude.Integer ->
                  Prelude.Integer -> Prelude.Maybe Prelude.Integer
...
coq_Bexact_inverse_mantissa prec =
  BinInt._Z__iter ((Prelude.-) prec ((\x -> x) 1)) (\x ->
    (\x -> 2 Prelude.* x) x) 1
...
coq_Bparse prec emax base m e =
  ...
  (\fO fP fN n -> if n Prelude.== 0 then fO () else
    ...
    (\p ->
    case BinInt._Z__ltb ((Prelude.*) e (BinInt._Z__log2 ((\x -> x) base)))
           emax of {
     Prelude.True ->
      coq_BofZ prec emax
        ((Prelude.*) ((\x -> x) m) ((\x -> x) (pos_pow base p)));
    ...
    case BinInt._Z__ltb
     ...
     Prelude.False ->
      Fappli_IEEE.coq_FF2B prec emax
        (case Fappli_IEEE.coq_Fdiv_core_binary prec ((\x -> x) m) 0
                ((\x -> x) (pos_pow base p)) 0 of {
          (,) p0 lz ->
           case p0 of {
            (,) mz ez ->
             (\fO fP fN n -> if n Prelude.== 0 then fO () else
