...
plus_fct :: (Rdefinitions.R -> Rdefinitions.R) -> (Rdefinitions.R ->
            Rdefinitions.R) -> Rdefinitions.R -> Rdefinitions.R
plus_fct f1 f2 x =
  Rdefinitions.coq_Rplus (f1 x) (f2 x)

opp_fct :: (Rdefinitions.R -> Rdefinitions.R) -> Rdefinitions.R ->
           Rdefinitions.R
opp_fct f x =
  Rdefinitions.coq_Ropp (f x)

mult_fct :: (Rdefinitions.R -> Rdefinitions.R) -> (Rdefinitions.R ->
            Rdefinitions.R) -> Rdefinitions.R -> Rdefinitions.R
mult_fct f1 f2 x =
...
div_fct :: (Rdefinitions.R -> Rdefinitions.R) -> (Rdefinitions.R ->
           Rdefinitions.R) -> Rdefinitions.R -> Rdefinitions.R
div_fct f1 f2 x =
...
comp :: (Rdefinitions.R -> Rdefinitions.R) -> (Rdefinitions.R ->
        Rdefinitions.R) -> Rdefinitions.R -> Rdefinitions.R
comp f1 f2 x =
  f1 (f2 x)

inv_fct :: (Rdefinitions.R -> Rdefinitions.R) -> Rdefinitions.R ->
           Rdefinitions.R
inv_fct f x =
...
derive :: (Rdefinitions.R -> Rdefinitions.R) -> Coq_derivable ->
          Rdefinitions.R -> Rdefinitions.R
derive f pr x =
  derive_pt f x (pr x)
...
data Differential_D2 =
   Coq_mkDifferential_D2 (Rdefinitions.R -> Rdefinitions.R) Coq_derivable 
 Coq_derivable
