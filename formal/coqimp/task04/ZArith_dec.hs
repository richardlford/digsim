...
coq_Dcompare_inf r =
  Datatypes.comparison_rec (Prelude.Just Prelude.True) (Prelude.Just
    Prelude.False) Prelude.Nothing r

coq_Zcompare_rect :: Prelude.Integer -> Prelude.Integer -> (() -> a1) -> (()
                     -> a1) -> (() -> a1) -> a1
...
coq_Zcompare_rec :: Prelude.Integer -> Prelude.Integer -> (() -> a1) -> (()
                    -> a1) -> (() -> a1) -> a1
coq_Zcompare_rec =
  coq_Zcompare_rect
...
coq_Z_dec' :: Prelude.Integer -> Prelude.Integer -> Prelude.Maybe
              Prelude.Bool
coq_Z_dec' x y =
