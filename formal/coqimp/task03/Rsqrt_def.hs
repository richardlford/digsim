...
dicho_lb :: Rdefinitions.R -> Rdefinitions.R -> (Rdefinitions.R -> Prelude.Bool) ->
            Prelude.Integer -> Rdefinitions.R
dicho_lb =
  coq_Dichotomy_lb

dicho_up :: Rdefinitions.R -> Rdefinitions.R -> (Rdefinitions.R -> Prelude.Bool) ->
            Prelude.Integer -> Rdefinitions.R
dicho_up =
  coq_Dichotomy_ub

dicho_lb_cv :: Rdefinitions.R -> Rdefinitions.R -> (Rdefinitions.R -> Prelude.Bool)
               -> Rdefinitions.R
dicho_lb_cv x y p =
  SeqProp.growing_cv (dicho_lb x y p)

dicho_up_cv :: Rdefinitions.R -> Rdefinitions.R -> (Rdefinitions.R -> Prelude.Bool)
               -> Rdefinitions.R
dicho_up_cv x y p =
...
coq_IVT :: (Rdefinitions.R -> Rdefinitions.R) -> Rdefinitions.R -> Rdefinitions.R ->
           Rdefinitions.R
coq_IVT f x y =
