...
coq_Z_spec_rect :: Prelude.Integer -> (() -> a1) -> (Prelude.Integer -> () -> a1) ->
                   (Prelude.Integer -> () -> a1) -> Prelude.Integer -> Z_spec -> a1
...
coq_Z_spec_rec :: Prelude.Integer -> (() -> a1) -> (Prelude.Integer -> () -> a1) ->
                  (Prelude.Integer -> () -> a1) -> Prelude.Integer -> Z_spec -> a1
coq_Z_spec_rec =
  coq_Z_spec_rect
...
intP x =
  (\fO fP fN n -> if n Prelude.== 0 then fO () else
    ...
    CMorphisms.coq_Reflexive_partial_app_morphism __
      ...
      ((\x -> x) p) __ ((\x -> x) p) (BinInt._Z__of_nat (BinPos._Pos__to_nat p)) __
      (ZintPos (BinPos._Pos__to_nat p)))
    (\p ->
    Logic.eq_rec (BinInt._Z__opp ((\x -> x) p))
      (CMorphisms.coq_Reflexive_partial_app_morphism __
        ...
        (BinInt._Z__opp (BinInt._Z__of_nat (BinPos._Pos__to_nat p))) __ (ZintNeg
        (BinPos._Pos__to_nat p))) (Prelude.negate p))
    x
...
sum_f_R0 :: (Prelude.Integer -> Rdefinitions.R) -> Prelude.Integer -> Rdefinitions.R
sum_f_R0 f n =
  (\fO fS n -> if n Prelude.== 0 then fO () else fS (n Prelude.- 1))
    (\_ -> f 0)
...
sum_f :: Prelude.Integer -> Prelude.Integer -> (Prelude.Integer -> Rdefinitions.R)
         -> Rdefinitions.R
sum_f s n f =
