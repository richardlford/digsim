...
_Pos__sqrtrem_step :: (Prelude.Integer -> Prelude.Integer) -> (Prelude.Integer ->
                      Prelude.Integer) -> ((,) Prelude.Integer Pos__Coq_mask) -> (,)
                      Prelude.Integer Pos__Coq_mask
        ...
        case _Pos__compare a' b' of {
         ...
         Datatypes.Lt ->
          case _Pos__ggcdn n0 (_Pos__sub b' a') a of {
           (,) g p ->
            case p of {
             (,) ba aa -> (,) g ((,) aa (_Pos__add aa ((\x -> 2 Prelude.* x) ba)))}};
         Datatypes.Gt ->
          case _Pos__ggcdn n0 (_Pos__sub a' b') b of {
           (,) g p ->
            case p of {
             (,) ab bb -> (,) g ((,) (_Pos__add bb ((\x -> 2 Prelude.* x) ab)) bb)}}})
        (\b0 ->
...
_Pos__of_uint d =
  case d of {
   ...
   Decimal.D6 l -> BinNums.Npos
    (_Pos__of_uint_acc l ((\x -> 2 Prelude.* x) ((\x -> 2 Prelude.* x Prelude.+ 1)
      1)));
...
_Pos__peano_rect :: a1 -> (Prelude.Integer -> a1 -> a1) -> Prelude.Integer -> a1
_Pos__peano_rect a f p =
  let {
   f2 = _Pos__peano_rect (f 1 a) (\p0 x ->
          f (_Pos__succ ((\x -> 2 Prelude.* x) p0)) (f ((\x -> 2 Prelude.* x) p0) x))}
  in
  (\fI fO fH n -> if n Prelude.== 1 then fH () else
                   if Prelude.odd n
                   then fI (n `Prelude.div` 2)
...
_Pos__peano_rec :: a1 -> (Prelude.Integer -> a1 -> a1) -> Prelude.Integer -> a1
_Pos__peano_rec =
  _Pos__peano_rect
...
_Pos__coq_PeanoView_rect :: a1 -> (Prelude.Integer -> Pos__PeanoView -> a1 -> a1) ->
...
_Pos__coq_PeanoView_rec :: a1 -> (Prelude.Integer -> Pos__PeanoView -> a1 -> a1) ->
                           Prelude.Integer -> Pos__PeanoView -> a1
...
_Pos__peanoView_xO _ q =
  case q of {
   ...
   Pos__PeanoSucc p q0 -> Pos__PeanoSucc (_Pos__succ ((\x -> 2 Prelude.* x) p))
    (Pos__PeanoSucc ((\x -> 2 Prelude.* x) p) (_Pos__peanoView_xO p q0))}

_Pos__peanoView_xI :: Prelude.Integer -> Pos__PeanoView -> Pos__PeanoView
_Pos__peanoView_xI _ q =
  case q of {
   Pos__PeanoOne -> Pos__PeanoSucc (_Pos__succ 1) (Pos__PeanoSucc 1 Pos__PeanoOne);
...
_Pos__coq_PeanoView_iter :: a1 -> (Prelude.Integer -> a1 -> a1) -> Prelude.Integer
                            -> Pos__PeanoView -> a1
...
_Pos__Private_Dec__max_dec :: Prelude.Integer -> Prelude.Integer -> Prelude.Bool
_Pos__Private_Dec__max_dec n m =
  _Pos__Private_Dec__max_case n m (\_ _ _ h0 -> h0) Prelude.True Prelude.False
...
_Pos__Private_Dec__min_dec :: Prelude.Integer -> Prelude.Integer -> Prelude.Bool
_Pos__Private_Dec__min_dec n m =
  _Pos__Private_Dec__min_case n m (\_ _ _ h0 -> h0) Prelude.True Prelude.False

_Pos__max_case_strong :: Prelude.Integer -> Prelude.Integer -> (() -> a1) -> (() ->
                         a1) -> a1
_Pos__max_case_strong n m x x0 =
  _Pos__Private_Dec__max_case_strong n m (\_ _ _ x1 -> Logic.eq_rect __ x1 __) x x0
...
_Pos__min_case_strong n m x x0 =
  _Pos__Private_Dec__min_case_strong n m (\_ _ _ x1 -> Logic.eq_rect __ x1 __) x x0
