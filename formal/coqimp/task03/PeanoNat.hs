...
_Nat__compare :: Prelude.Integer -> Prelude.Integer -> Datatypes.Coq_comparison
_Nat__compare n m =
   ...
   Decimal.D3 d0 ->
    _Nat__of_uint_acc d0 (Prelude.succ (Prelude.succ (Prelude.succ
      (_Nat__tail_mul (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ
        ...
        (Prelude.succ 0)))))))))) acc))));
   Decimal.D4 d0 ->
    _Nat__of_uint_acc d0 (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ
      (_Nat__tail_mul (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ
        (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ (Prelude.succ
        (Prelude.succ 0)))))))))) acc)))));
   Decimal.D5 d0 ->
...
_Nat__to_little_uint :: Prelude.Integer -> Decimal.Coq_uint -> Decimal.Coq_uint
...
_Nat__div :: Prelude.Integer -> Prelude.Integer -> Prelude.Integer
...
_Nat__bitwise :: (Prelude.Bool -> Prelude.Bool -> Prelude.Bool) -> Prelude.Integer
                 -> Prelude.Integer -> Prelude.Integer -> Prelude.Integer
...
_Nat__recursion :: a1 -> (Prelude.Integer -> a1 -> a1) -> Prelude.Integer -> a1
_Nat__recursion =
  Datatypes.nat_rect
...
_Nat__Private_Dec__max_dec :: Prelude.Integer -> Prelude.Integer -> Prelude.Bool
_Nat__Private_Dec__max_dec n m =
  _Nat__Private_Dec__max_case n m (\_ _ _ h0 -> h0) Prelude.True Prelude.False
...
_Nat__Private_Dec__min_dec :: Prelude.Integer -> Prelude.Integer -> Prelude.Bool
_Nat__Private_Dec__min_dec n m =
  _Nat__Private_Dec__min_case n m (\_ _ _ h0 -> h0) Prelude.True Prelude.False

_Nat__max_case_strong :: Prelude.Integer -> Prelude.Integer -> (() -> a1) -> (() ->
                         a1) -> a1
_Nat__max_case_strong n m x x0 =
  _Nat__Private_Dec__max_case_strong n m (\_ _ _ x1 -> Logic.eq_rect __ x1 __) x x0
...
_Nat__min_case_strong n m x x0 =
  _Nat__Private_Dec__min_case_strong n m (\_ _ _ x1 -> Logic.eq_rect __ x1 __) x x0
...
_Nat__lcm a b =
  (Prelude.*) a (_Nat__div b (_Nat__gcd a b))
