...
full_float_rect :: (Prelude.Bool -> a1) -> (Prelude.Bool -> a1) -> (Prelude.Bool ->
                   Prelude.Integer -> a1) -> (Prelude.Bool -> Prelude.Integer ->
                   Prelude.Integer -> a1) -> Coq_full_float -> a1
...
full_float_rec :: (Prelude.Bool -> a1) -> (Prelude.Bool -> a1) -> (Prelude.Bool ->
                  Prelude.Integer -> a1) -> (Prelude.Bool -> Prelude.Integer ->
                  Prelude.Integer -> a1) -> Coq_full_float -> a1
full_float_rec =
  full_float_rect
...
canonic_mantissa prec emax =
  ...
  (\m e ->
  Zbool.coq_Zeq_bool (fexp ((Prelude.+) ((\x -> x) (Fcore_digits.digits2_pos m)) e))
    e)

bounded :: Prelude.Integer -> Prelude.Integer -> Prelude.Integer -> Prelude.Integer
           -> Prelude.Bool
bounded prec emax m e =
  (Prelude.&&) (canonic_mantissa prec emax m e)
    (BinInt._Z__leb e ((Prelude.-) emax prec))

valid_binary :: Prelude.Integer -> Prelude.Integer -> Coq_full_float -> Prelude.Bool
valid_binary prec emax x =
  case x of {
   F754_nan _ pl -> BinInt._Z__ltb ((\x -> x) (Fcore_digits.digits2_pos pl)) prec;
...
binary_float_rect :: Prelude.Integer -> Prelude.Integer -> (Prelude.Bool -> a1) ->
                     (Prelude.Bool -> a1) -> (Prelude.Bool -> Coq_nan_pl -> a1) ->
                     (Prelude.Bool -> Prelude.Integer -> Prelude.Integer -> () ->
                     a1) -> Coq_binary_float -> a1
...
binary_float_rec :: Prelude.Integer -> Prelude.Integer -> (Prelude.Bool -> a1) ->
                    (Prelude.Bool -> a1) -> (Prelude.Bool -> Coq_nan_pl -> a1) ->
                    (Prelude.Bool -> Prelude.Integer -> Prelude.Integer -> () -> a1)
                    -> Coq_binary_float -> a1
binary_float_rec =
  binary_float_rect
...
coq_B2FF :: Prelude.Integer -> Prelude.Integer -> Coq_binary_float -> Coq_full_float
coq_B2FF _ _ x =
  case x of {
...
coq_Bsign :: Prelude.Integer -> Prelude.Integer -> Coq_binary_float -> Prelude.Bool
coq_Bsign _ _ x =
  case x of {
   B754_zero s -> s;
   B754_infinity s -> s;
...
is_finite :: Prelude.Integer -> Prelude.Integer -> Coq_binary_float -> Prelude.Bool
is_finite _ _ f =
  case f of {
...
is_nan :: Prelude.Integer -> Prelude.Integer -> Coq_binary_float -> Prelude.Bool
is_nan _ _ f =
  case f of {
...
coq_Bopp :: Prelude.Integer -> Prelude.Integer -> (Prelude.Bool -> Coq_nan_pl -> (,)
            Prelude.Bool Coq_nan_pl) -> Coq_binary_float -> Coq_binary_float
...
shr :: Coq_shr_record -> Prelude.Integer -> Prelude.Integer -> (,) Coq_shr_record
       Prelude.Integer
shr mrs e n =
  (\fO fP fN n -> if n Prelude.== 0 then fO () else
                   if n Prelude.> 0 then fP n else
...
binary_overflow :: Prelude.Integer -> Prelude.Integer -> Coq_mode -> Prelude.Bool ->
                   Coq_full_float
  ...
  case overflow_to_inf m s of {
   ...
   Prelude.False -> F754_finite s
    ((\fO fP fN n -> if n Prelude.== 0 then fO () else
       ...
       (\_ ->
       1)
       ((Prelude.-) (BinInt._Z__pow ((\x -> x) ((\x -> 2 Prelude.* x) 1)) prec)
         ((\x -> x) 1))) ((Prelude.-) emax prec)}

binary_round_aux :: Prelude.Integer -> Prelude.Integer -> Coq_mode -> Prelude.Bool
     ...
     B754_finite sy my ey ->
      coq_FF2B prec emax
        (binary_round_aux prec emax m (Datatypes.xorb sx sy)
          (BinPos._Pos__mul mx my) ((Prelude.+) ex ey) Fcalc_bracket.Coq_loc_Exact)}}

coq_Bmult_FF :: Prelude.Integer -> Prelude.Integer -> (Coq_full_float ->
                Coq_full_float -> (,) Prelude.Bool Prelude.Integer) -> Coq_mode ->
                Coq_full_float -> Coq_full_float -> Coq_full_float
...
shl_align_fexp prec emax =
  ...
  let {fexp = Fcore_FLT.coq_FLT_exp emin prec} in
  (\mx ex ->
  shl_align mx ex (fexp ((Prelude.+) ((\x -> x) (Fcore_digits.digits2_pos mx)) ex)))

binary_round :: Prelude.Integer -> Prelude.Integer -> Coq_mode -> Prelude.Bool ->
                Prelude.Integer -> Prelude.Integer -> Coq_full_float
    ...
    case y of {
     ...
     B754_finite sy my ey ->
      ...
      binary_normalize prec emax m
        ((Prelude.+)
          (Fcore_Zaux.cond_Zopp sx ((\x -> x) (Prelude.fst (shl_align mx ex ez))))
          (Fcore_Zaux.cond_Zopp sy ((\x -> x) (Prelude.fst (shl_align my ey ez)))))
        ez (case m of {
...
coq_Fsqrt_core_binary prec m e =
  ...
  let {
   s = Prelude.max
         ((Prelude.-) ((Prelude.*) ((\x -> x) ((\x -> 2 Prelude.* x) 1)) prec) d) 0}
  in
