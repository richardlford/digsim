...
string_rect :: a1 -> (Prelude.Char -> Prelude.String -> a1 -> a1) -> Prelude.String
               -> a1
string_rect f f0 s =
  case s of {
   ([]) -> f;
...
string_rec :: a1 -> (Prelude.Char -> Prelude.String -> a1 -> a1) -> Prelude.String
              -> a1
string_rec =
  string_rect
...
findex :: Prelude.Integer -> Prelude.String -> Prelude.String -> Prelude.Integer
findex n s1 s2 =
  case index n s1 s2 of {
   Prelude.Just n0 -> n0;
   Prelude.Nothing -> 0}
