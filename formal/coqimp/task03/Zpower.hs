...
coq_Zdiv_rest_aux :: ((,) ((,) Prelude.Integer Prelude.Integer) Prelude.Integer) ->
...
coq_Zdiv_rest_proofs_rect :: Prelude.Integer -> Prelude.Integer -> (Prelude.Integer
                             -> Prelude.Integer -> () -> () -> () -> a1) ->
                             Zdiv_rest_proofs -> a1
...
coq_Zdiv_rest_proofs_rec :: Prelude.Integer -> Prelude.Integer -> (Prelude.Integer
                            -> Prelude.Integer -> () -> () -> () -> a1) ->
                            Zdiv_rest_proofs -> a1
coq_Zdiv_rest_proofs_rec =
  coq_Zdiv_rest_proofs_rect

coq_Zdiv_rest_correct :: Prelude.Integer -> Prelude.Integer -> Zdiv_rest_proofs
coq_Zdiv_rest_correct x p =
  let {p0 = BinPos._Pos__iter coq_Zdiv_rest_aux ((,) ((,) x 0) ((\x -> x) 1)) p} in
  case p0 of {
   (,) p1 x0 ->
    case p1 of {
     (,) q r ->
