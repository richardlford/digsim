...
coq_Zfast_pow_pos v e =
  (\fI fO fH n -> if n Prelude.== 1 then fH () else
    ...
    (\e' -> (Prelude.*) v (BinInt._Z__square (coq_Zfast_pow_pos v e')))
    (\e' -> BinInt._Z__square (coq_Zfast_pow_pos v e'))
    (\_ -> v)
    e

coq_Zpos_div_eucl_aux1 :: Prelude.Integer -> Prelude.Integer -> (,) Prelude.Integer
                          Prelude.Integer
...
coq_Zpos_div_eucl_aux :: Prelude.Integer -> Prelude.Integer -> (,) Prelude.Integer
                         Prelude.Integer
...
coq_Zfast_div_eucl :: Prelude.Integer -> Prelude.Integer -> (,) Prelude.Integer
                      Prelude.Integer
