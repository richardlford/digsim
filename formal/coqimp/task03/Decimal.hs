...
uint_rect :: a1 -> (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 -> a1) -> (Coq_uint ->
             a1 -> a1) -> (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 -> a1) ->
             (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 ->
             a1) -> (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 -> a1) -> Coq_uint ->
             a1
...
uint_rec :: a1 -> (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 -> a1) -> (Coq_uint ->
            a1 -> a1) -> (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 -> a1) ->
            (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 ->
            a1) -> (Coq_uint -> a1 -> a1) -> (Coq_uint -> a1 -> a1) -> Coq_uint ->
            a1
