...
Definition svIndex (Sv: stateVar) : positive :=
  ...
  | SvCMZ_PER_DELR => 19
  | SvCX_BASE => 20
  | SvCX_PER_ALPHA_TOTAL => 21
  | SvCY_PER_BETA => 22
  | SvCZ_PER_ALPHA => 23
  | SvDEL_CMD_PER_P_CMD => 24
  | SvDEL_CMD_PER_Q_CMD => 25
  | SvDEL_CMD_PER_R_CMD => 26
  | SvFAEROX_BI_B => 27
  | SvFAEROY_BI_B => 28
  | SvFAEROZ_BI_B => 29
  | SvFIN_1_CMD => 30
...
Definition actuator_default_data_str : list (stateVar * string) :=
  [
            {"FIN_1_CMD", 0.0},
            {"FIN_2_CMD", 0.0},
            {"FIN_3_CMD", 0.0},
            {"FIN_4_CMD", 0.0},
            {"FIN_LIMIT", 20.0 / rd_to_dg()}
  ].

Definition aero_default_data_str : list (stateVar * string) :=
  [
            {"AIR_DENSITY",        1.0},
            {"CX_BASE",            0.3},
...
Definition mass_default_data_str : list (stateVar * string) :=
  [
            {"IXX_B",  0.1},
            {"IYY_B",  0.75},
            {"IZZ_B",  0.75},
...
Definition kinematics_default_data_str : list (stateVar * string) :=
  [
            {"PSI_B_IC_DG",   0.0},
            {"THETA_B_IC_DG", 0.0},
            {"PHI_B_IC_DG",   0.0},
...
Definition gyro_default_data_str : list (stateVar * string) :=
  [
  ].

Definition target_default_data_str : list (stateVar * string) :=
  [
            {"X_TI_I_IC",  500.0},
            {"Y_TI_I_IC",  -250.0},
            {"Z_TI_I_IC",  0.0},
...
Definition flight_computer_default_data_str : list (stateVar * string) :=
  [
