...
(* Driver common *)
| SvT | SvT_STOP | SvDT | SvDT_MAX | SvDT_MIN | SvDT_PRINT
(* Model specific *) | SvACC_GRAVITY | SvAIR_DENSITY | SvALPHA | SvALPHA_TOTAL | SvBETA
| SvCMP | SvCMQ | SvCMR | SvCMX_PER_DELP | SvCMY_PER_ALPHA | SvCMY_PER_DELQ | SvCMZ_PER_BETA | SvCMZ_PER_DELR
| SvCX_BASE | SvCX_PER_ALPHA_TOTAL | SvCY_PER_BETA | SvCZ_PER_ALPHA | SvDEL_CMD_PER_P_CMD | SvDEL_CMD_PER_Q_CMD
| SvDEL_CMD_PER_R_CMD | SvFAEROX_BI_B | SvFAEROY_BI_B | SvFAEROZ_BI_B | SvFIN_1_CMD | SvFIN_1_POSITION
| SvFIN_2_CMD | SvFIN_2_POSITION | SvFIN_3_CMD | SvFIN_3_POSITION | SvFIN_4_CMD | SvFIN_4_POSITION
| SvFIN_LIMIT | SvIXX_B | SvIYY_B | SvIZZ_B | SvMAEROX_BI_B | SvMAEROY_BI_B | SvMAEROZ_BI_B | SvMASS_B
| SvP_B | SvP_B_CMD | SvP_B_IC_DG | SvPD_B | SvP_G_MEAS | SvPHI_B | SvPHI_B_EST | SvPHI_B_EST_DG | SvPHI_B_IC_DG
| SvPITCH_GUIDANCE_GAIN | SvP_S | SvPSI_B | SvPSI_B_EST | SvPSI_B_EST_DG | SvPSI_B_IC_DG | SvQ0_B | SvQ0_B_EST
| SvQ0D_B | SvQ0D_B_EST | SvQ1_B | SvQ1_B_EST | SvQ1D_B | SvQ1D_B_EST | SvQ2_B | SvQ2_B_EST | SvQ2D_B | SvQ2D_B_EST
| SvQ3_B | SvQ3_B_EST | SvQ3D_B | SvQ3D_B_EST | SvQ_B | SvQ_B_CMD | SvQ_B_CMD_BIAS | SvQ_B_IC_DG | SvQD_B | SvQ_G_MEAS
| SvQ_S | SvQ_SI_B_MEAS | SvRANGE_TB_SQ | SvR_B | SvR_B_CMD | SvR_B_IC_DG | SvRD_B | SvREF_AREA | SvREF_LENGTH | SvR_G_MEAS
| SvROLL_GUIDANCE_GAIN | SvR_S | SvR_SI_B_MEAS | SvTHETA_B | SvTHETA_B_EST | SvTHETA_B_EST_DG | SvTHETA_B_IC_DG
| SvTIB11 | SvTIB12 | SvTIB13 | SvTIB21 | SvTIB22 | SvTIB23 | SvTIB31 | SvTIB32 | SvTIB33
| SvX_BI_I | SvX_BI_I_IC | SvXD_BI_I | SvXD_BI_I_IC | SvXDD_BI_I | SvXD_TB_I | SvXD_TI_I | SvXD_TI_I_IC
| SvX_TB_I | SvX_TI_I | SvX_TI_I_IC | SvYAW_GUIDANCE_GAIN | SvY_BI_I | SvY_BI_I_IC
| SvYD_BI_I | SvYD_BI_I_IC | SvYDD_BI_I | SvYD_TB_I | SvYD_TI_I | SvYD_TI_I_IC
| SvY_TB_I | SvY_TI_I | SvY_TI_I_IC | SvZ_BI_I | SvZ_BI_I_IC
| SvZD_BI_I | SvZD_BI_I_IC | SvZDD_BI_I | SvZD_TB_I | SvZD_TI_I | SvZD_TI_I_IC | SvZ_TB_I | SvZ_TI_I | SvZ_TI_I_IC.
...
Definition svIndex (Sv: stateVar) : positive :=
  ...
  | SvDEL_CMD_PER_Q_CMD => 25   | SvDEL_CMD_PER_R_CMD => 26   | SvFAEROX_BI_B => 27   | SvFAEROY_BI_B => 28
  | SvFAEROZ_BI_B => 29   | SvFIN_1_CMD => 30   | SvFIN_1_POSITION => 31   | SvFIN_2_CMD => 32
  ...
  | SvMASS_B => 45   | SvP_B => 46   | SvP_B_CMD => 47   | SvP_B_IC_DG => 48
