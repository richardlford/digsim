...
type Coq_radix = Prelude.Integer
...
coq_Zpos_div_eucl_aux1 :: Prelude.Integer -> Prelude.Integer -> (,) Prelude.Integer Prelude.Integer
  ...
  (\fI fO fH n -> if n Prelude.== 1 then fH () else
    ...
    (\fI fO fH n -> if n Prelude.== 1 then fH () else
      ...
      case coq_Zpos_div_eucl_aux1 a' b' of {
       (,) q r -> (,) q
        ((Prelude.+) ((Prelude.*) ((\x -> x) ((\x -> 2 Prelude.* x) 1)) r) ((\x -> x) 1))})
      (\a' ->
      case coq_Zpos_div_eucl_aux1 a' b' of {
...
coq_Zpos_div_eucl_aux :: Prelude.Integer -> Prelude.Integer -> (,) Prelude.Integer Prelude.Integer
...
coq_Zfast_div_eucl :: Prelude.Integer -> Prelude.Integer -> (,) Prelude.Integer Prelude.Integer
      ...
      case coq_Zpos_div_eucl_aux a' b' of {
       (,) q r ->
        (\fO fP fN n -> if n Prelude.== 0 then fO () else
          ...
          (\_ -> (,) (BinInt._Z__opp ((Prelude.+) q ((\x -> x) 1))) ((Prelude.+) b r))
          (\_ -> (,) (BinInt._Z__opp ((Prelude.+) q ((\x -> x) 1))) ((Prelude.+) b r))
          r})
      b)
    (\a' ->
      ...
      case coq_Zpos_div_eucl_aux a' b' of {
       (,) q r ->
        (\fO fP fN n -> if n Prelude.== 0 then fO () else
          ...
          (\_ -> (,) (BinInt._Z__opp ((Prelude.+) q ((\x -> x) 1))) ((Prelude.-) b r))
          r})
      (\b' -> case coq_Zpos_div_eucl_aux a' b' of {
