...
new_location_even :: Prelude.Integer -> Prelude.Integer -> Coq_location -> Coq_location
new_location_even nb_steps k l =
  case Zbool.coq_Zeq_bool k 0 of {
   Prelude.True -> case l of {
                    Coq_loc_Exact -> l;
                    Coq_loc_Inexact _ -> Coq_loc_Inexact Datatypes.Lt};
   Prelude.False -> Coq_loc_Inexact
    (case BinInt._Z__compare ((Prelude.*) ((\x -> x) ((\x -> 2 Prelude.* x) 1)) k) nb_steps of {
      Datatypes.Eq -> case l of {
                       Coq_loc_Exact -> Datatypes.Eq;
                       Coq_loc_Inexact _ -> Datatypes.Gt};
      x -> x})}

new_location_odd :: Prelude.Integer -> Prelude.Integer -> Coq_location -> Coq_location
  ...
  case Zbool.coq_Zeq_bool k 0 of {
   ...
   Prelude.False -> Coq_loc_Inexact
    (case BinInt._Z__compare
            ((Prelude.+) ((Prelude.*) ((\x -> x) ((\x -> 2 Prelude.* x) 1)) k) ((\x -> x) 1))
            nb_steps of {
      Datatypes.Eq -> case l of {
