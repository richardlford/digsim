...
void airframe_response() {
  ...
  REAL acc_alpha,acc_beta,acc_per_alpha,acc_per_beta,alpha_cmd,
    adrag,beta_cmd,beta_prime,calpha,cbetap,
    velsq,xd_bi_b,yd_bi_b,zd_bi_b,y_acc_max,z_acc_max,vmag,
    tstb11,tstb12,tstb13,tstb21,tstb22,tstb23,tstb31,tstb32,tstb33,
    salpha,sbetap,y_acc_cmd,br2,ar11,ar21,ar22,z_acc_cmd,bq2,aq11,aq21,aq22;
