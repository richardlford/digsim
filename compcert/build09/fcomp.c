...
#define q0_b_est            real_array[303].r
#define q1_b_est            real_array[304].r
#define q2_b_est            real_array[305].r
#define q3_b_est            real_array[306].r
#define q0d_b_est           real_array[307].r
#define q1d_b_est           real_array[308].r
#define q2d_b_est           real_array[309].r
#define q3d_b_est           real_array[310].r
#define pitch_guidance_gain real_array[311].r
#define roll_guidance_gain  real_array[312].r
#define yaw_guidance_gain   real_array[313].r
#define psi_b_est_dg        real_array[314].r
#define theta_b_est_dg      real_array[315].r
#define phi_b_est_dg        real_array[316].r
#define psi_b_est           real_array[317].r
#define theta_b_est         real_array[318].r
#define phi_b_est           real_array[319].r
#define q_b_cmd_bias        real_array[320].r
...
void flight_computer(void) {
  ...
  REAL tib11_est,tib12_est,tib13_est,tib21_est,tib22_est,tib23_est,tib31_est,tib33_est,tib32_est,
    stheta_b_est,qmag_est;
