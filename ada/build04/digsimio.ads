...
package digsimio is
   ...
   type names is (time,time0,tstop,dt,dtmax,dtmin,dtprint,reeval,quit,damping_coefficient,gravity,mass,spring_coefficient,x_ic,xd_ic,x,xd,xdd);
   ...
   cell : array(names) of cells :=
     (time                => (real, 1, new string'("Simulation time [sec]"                                       ), global.time                'access),
      ...
      reeval              => (bool, 8, new string'("Indicates states changed value at a discrete event [Logical]"), global.reeval              'access),
